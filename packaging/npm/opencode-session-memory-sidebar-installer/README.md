...
- Global: `~/.config/opencode/tools/session_memory.js`
- Project: `.opencode/tools/session_memory.js`
...
```text
https://github.com/Topabaem05/CancerBroker/releases/download/CancerBroker-v0.1.4/CancerBroker.cjs
```
