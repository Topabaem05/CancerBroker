...
- Instala la herramienta OpenCode Session Memory sin clonar el repositorio:
...
- En OpenCode 1.2.22 se instala por defecto como la herramienta personalizada global `session_memory` en `~/.config/opencode/tools/`.
